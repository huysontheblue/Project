...
select dbo.KF_Check_SV_In_Khoa('1851', 'VL');
select dbo.KF_Check_SV_In_Khoa('1854', 'CNTT');
go
...
select dbo.KF_Last_Score_Of_Student('1854', 'MH3');
go
...
select dbo.KF_Last_AVG_Score_Of_Student('1857');
go
...
select * from dbo.KF_Last_List_Score_Of_Student('1857', 'MH1')